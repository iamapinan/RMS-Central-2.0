 ...
 * oauth_client.php
 *
 * @(#) $Id: oauth_client.php,v 1.42 2012/12/19 11:00:36 mlemos Exp $
 *
 */
...
<class>
	...
	<version>@(#) $Id: oauth_client.php,v 1.42 2012/12/19 11:00:36 mlemos Exp $</version>
...
*/
	...
	var $oauth_user_agent = 'PHP-OAuth-API (http://www.phpclasses.org/oauth-api $Revision: 1.42 $)';
	...
	Function Initialize()
	{
		switch($this->server)
		{
			...
			case 'Facebook':
				...
				$this->dialog_url = 'https://www.facebook.com/dialog/oauth?client_id={CLIENT_ID}&display=page&redirect_uri={REDIRECT_URI}&scope={SCOPE}&state={STATE}';
				$this->append_state_to_redirect_uri = '';
